...
public class CreateSeesaw : Create {
     ...
     */
    public void BuildSeesaw(Vector3 _minStart, Vector3 _maxStart, float _minLength, float _maxLength, float _minWidth, float _maxWidth,
